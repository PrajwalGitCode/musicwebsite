...
<body>
    ...
    <?php
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM instrument";
        $result = mysqli_query($conn,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $sql = "SELECT * FROM instrument LIMIT $offset, $no_of_records_per_page";
            ...
            echo'   <section class="play">
                    <div class="card" style="width:40rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                            <img class="card-img-top" src="images/' . $rat . '" alt="Card image cap">
    
                            <audio id="song1" src="audio/' . $kat . ' "controls></audio>
                        </div>
                    </div>
                </section>';
        }
