...
<body>
    ...
    <?php
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM approve";
        $result = mysqli_query($conn,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $sql = "SELECT * FROM approve LIMIT $offset, $no_of_records_per_page";
        ...
        echo'   <section class="play">
                <div class="card" style="width:40rem;">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">' . $dog . '</h6>
                        <p class="card-text">
                        <img class="card-img-top" src="https://images.8tracks.com/cover/i/000/313/145/anime-music-widescreen-original-693454-3168.jpg?rect=0,0,500,500&q=98&fm=jpg&fit=max" alt="Card image cap">

                        <audio id="song1" src="uploads/' . $kat . ' "controls></audio>
                    </div>
                </div>
            </section>';
        }
